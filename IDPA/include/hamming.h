...
static uint16_t hamming_15_4(uint16_t data) {
    uint16_t r1 = data & 0x6D58; // 110110101011000
    uint16_t r2 = data & 0x5B34; // 101101100110100
    uint16_t r3 = data & 0x38F2; // 011100011110010
    uint16_t r4 = data & 0x7F1;  // 000011111110001
...
/*
This one's 20-30 ms faster:

static uint16_t hamming_15_4_performance(uint16_t data) {
    uint16_t r1 = data & 0x6D58;
    uint16_t r2 = data & 0x5B34;
    uint16_t r3 = data & 0x38F2;
    uint16_t r4 = data & 0x7F1;

    return data ^ ((1 & ((r1 & 1) ^ ((r1 >> 1) & 1) ^ ((r1 >> 2) & 1) ^ ((r1 >> 3) & 1) ^ ((r1 >> 4) & 1) ^ ((r1 >> 5) & 1) ^ ((r1 >> 6) & 1) ^ ((r1 >> 7) & 1) ^ ((r1 >> 8) & 1) ^ ((r1 >> 9) & 1) ^ ((r1 >> 10) & 1) ^ ((r1 >> 11) & 1) ^ ((r1 >> 12) & 1) ^ ((r1 >> 13) & 1) ^ ((r1 >> 14) & 1))) << 3)
    ^ ((1 & ((r2 & 1) ^ ((r2 >> 1) & 1) ^ ((r2 >> 2) & 1) ^ ((r2 >> 3) & 1) ^ ((r2 >> 4) & 1) ^ ((r2 >> 5) & 1) ^ ((r2 >> 6) & 1) ^ ((r2 >> 7) & 1) ^ ((r2 >> 8) & 1) ^ ((r2 >> 9) & 1) ^ ((r2 >> 10) & 1) ^ ((r2 >> 11) & 1) ^ ((r2 >> 12) & 1) ^ ((r2 >> 13) & 1) ^ ((r2 >> 14) & 1))) << 2)
    ^ ((1 & ((r3 & 1) ^ ((r3 >> 1) & 1) ^ ((r3 >> 2) & 1) ^ ((r3 >> 3) & 1) ^ ((r3 >> 4) & 1) ^ ((r3 >> 5) & 1) ^ ((r3 >> 6) & 1) ^ ((r3 >> 7) & 1) ^ ((r3 >> 8) & 1) ^ ((r3 >> 9) & 1) ^ ((r3 >> 10) & 1) ^ ((r3 >> 11) & 1) ^ ((r3 >> 12) & 1) ^ ((r3 >> 13) & 1) ^ ((r3 >> 14) & 1))) << 1)
